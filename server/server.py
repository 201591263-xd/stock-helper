...
FALLBACK_POOL = {
    '科技': [('603019','中科曙光','算力中军100-500亿'), ('000977','浪潮信息','AI服务器'), ('000938','紫光股份','ICT基础设施'), ('002371','北方华创','半导体设备'), ('600584','长电科技','封测龙头')],
    'AI': [('002230','科大讯飞','AI大模型'), ('300418','昆仑万维','AI+游戏出海'), ('300229','拓尔思','NLP大数据'), ('300496','中科创达','智能OS'), ('688088','虹软科技','视觉AI')],
    '消费': [('603345','安井食品','速冻食品'), ('603517','绝味食品','卤制品连锁'), ('002568','百润股份','预调酒RIO'), ('600872','中炬高新','调味品二线'), ('002507','涪陵榨菜','消费品龙头')],
    '新能源': [('300073','当升科技','正极材料'), ('603659','璞泰来','负极+涂覆'), ('002812','恩捷股份','隔膜龙头'), ('002709','天赐材料','电解液龙头'), ('300769','德方纳米','磷酸铁锂')],
    '医药': [('002821','凯莱英','CDMO'), ('300759','康龙化成','CRO二线'), ('603127','昭衍新药','安评龙头'), ('300363','博腾股份','CDMO弹性'), ('688202','美迪西','CRO中小市值')],
    '金融': [('300803','指南针','券商+金融IT'), ('688318','财富趋势','通达信母公司'), ('603383','顶点软件','金融IT'), ('600446','金证股份','证券IT'), ('300773','拉卡拉','第三方支付')],
    '军工': [('688297','中无人机','无人机'), ('688239','航宇科技','航空锻件'), ('300855','图南股份','高温合金'), ('688281','华秦科技','隐身材料'), ('688375','国博电子','TR组件')],
    '周期': [('002738','中矿资源','锂矿+铯'), ('002240','盛新锂能','锂盐'), ('002756','永兴材料','锂云母'), ('603799','华友钴业','钴+前驱体'), ('002460','赣锋锂业','锂资源二线')],
}
...
选票原则（严格按优先级执行）：
1. 【远离龙头】候选池已排除超大盘龙头，你只能从候选池中选，禁止推荐池外的票
2. 【分歧优先】优先选当日换手活跃、涨幅适中（1%-5%）、有分歧但未破位的票，避开缩量秒板的一致股
3. 【弹性为王】优先100-500亿中盘弹性标的，避开缺乏波动的超大市值股
4. 【技术面】优先均线多头排列、MACD金叉、放量突破平台的标的
5. 结合历史战绩，优先选胜率高的标的
